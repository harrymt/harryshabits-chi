...
%
Rewards play an important role habit formation in terms of reinforcing a habit and increasing repetition~\cite{positive_reinforcement_pro}. An example of this in habit formation technologies is the use of coins and points as rewards to increase task repetition. However, studies have show this form of extrinsic rewards can also reduce motivation and therefore hinder habit development in the long run~\cite{article_meta_analytic_review_intrinsic_motivation}.
...
%
An alternative approach is to provide intrinsic rather than extrinsic motivation after a habit is completed~\cite{article_a_self_efficacy, article_meta_analytic_review_intrinsic_motivation}.
