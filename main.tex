...
\begin{abstract}
Rewarding yourself after a difficult task, encourages you to complete the task again. Habit formation systems use rewards to encourage and motivate people to form new habits. This paper compares three types of positive reinforcement rewards from two modalities, visual and auditory, to see how they effect habit formation. 36 people participated in a 4-week study followed by voluntary semi-structured interviews. Four groups received different types of rewards from a different mode: no reward, visual, auditory, and visual-auditory combined. The results showed: (TODO summarise key findings from both hypothesis)... the effectiveness of these chosen rewards on users habit strength and analysis on the motivation about each modality. Semi-structured user interviews, combined with the data analysis, found at the end of the 4-week period: i) visual rewards had the highest increase in habit strength, ii) ..., finally, iii) participants found interacting with the chatbot fun.
