...
%
An alternative approach is to provide intrinsic rather than extrinsic motivation after a habit is completed~\cite{article_a_self_efficacy, article_meta_analytic_review_intrinsic_motivation} \textbf{[should give a ]}.
