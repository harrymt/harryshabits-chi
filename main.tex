...
An independent-samples t-test was conducted to compare both SRBAI one and SRBAI two for rewards and control (Figure~\ref{fig:m2_h1}). For SRBAI one, there was also no significant differences in scores for rewards (mean = 14.33, SD = 3.84) and control (mean = 13.50, SD = 4.94; $t(9) = 0.224$, $p = 0.85$,
...
\subsubsection{Multiple vs. single-mode feedback}
...
\subsubsection{Continuation with habit formation}
