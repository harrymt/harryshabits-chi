...
Positive reinforcement plays an important role in habit formation. It is used as a reward to reinforce a habit and increase repetition~\cite{positive_reinforcement_pro}. Current habit formation technology uses extrinsic monetary rewards, such as coins and points. However, although this type of reward increases task repetition, it reduces motivation and therefore hinders habit formation~\cite{article_meta_analytic_review_intrinsic_motivation}. This paper tries to understand more about different types of intrinsic positive reinforcement and how it can be used to support the formation of new habits.
...
\emph{[Existing types of positive reinforcement~\cite{coaching_not_that_good}, ~\cite{chi_crowd_designed_motivation}]}

\emph{[How positive reinforcement is delivered. ~\cite{coaching_not_that_good}, ~\cite{chi_crowd_designed_motivation}
~\cite{article_dont_kick_habit}, ~\cite{article_realtime_feedback_improving_medication_taking}]}

\emph{[Strengths and limitations of the different types.
~\cite{article_dont_kick_habit}~\cite{article_realtime_feedback_improving_medication_taking}]}
...
\section{Comparing Different Positive Reinforcement}
...
\subsubsection{Automaticity did not develop}
...
\subsubsection{Audio-visual rewards had highest automaticity scores}
