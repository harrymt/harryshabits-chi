...
\usepackage[style=numeric,sorting=nty, eprint=false,doi=false,isbn=false,url=false, maxbibnames=99, firstinits=true]{biblatex}
...
Seven participants agreed to participate in optional interviews. Their details are summarised in Table~\ref{table:}. Below we summarise the key findings related to participants' experiences of repeating the habit and support provided by the bot, their attitudes towards types of positive reinforcement they received, and towards the bot itself.
...
\begin{table}[b]
  ...
  \begin{tabular}{l l l l l l}
    % \toprule
    {\small\textit{Number}} & {\small \textit{Age}} & {\small \textit{Gender}} & {\small \textit{Habit}} & {\small \textit{Reward}} & {\small \textit{Habit Completion rate}}\\
    \midrule
    1 & 24 & Male & Visual & Meditation & X\% \\
    2 & 19 & Female & Auditory & Stretch & X\% \\ 
    3 & 28 & Female & Visual & Writing & X\% \\
    4 & 57 & Female & No reward & Meditation & X\% \\ 
    5 & 25 & Male & Visual & Meditation & X\% \\ 
    6 & 21 & Female & No reward & Meditation & X\% \\ 
    7 & 32 & Male & Visual-Auditory & Stretch & X\% \\
    % \bottomrule
  \end{tabular}
  \caption{Interviewed participants breakdown.}~\label{fig:transcript_participant_breakdown}
\end{table}
